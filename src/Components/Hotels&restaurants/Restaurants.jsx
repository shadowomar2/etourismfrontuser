...
export default function Restaurants() {
  ...
  useEffect(() => {
    fetchData("GET", "/test/restaurant", null, null)
  ...
  return (
    <div className="container">
          <h1 className='text-center animate__animated animate__backInDown'>Restaurants</h1>
      ...
      <div className="row">
        {search(currentTours).map((event) => (
          <div className="col-sm-6 col-md-4" key={event.id}>
              ...
              link="#"
              buttonText="Details"
              onClick={() => navigate(`/details_restaurant/${event.id}`)}
            />        
          </div>
        ))}
